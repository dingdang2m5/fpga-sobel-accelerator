...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 45 \
			corename sobel_top_CTRL_axilite \
			name sobel_top_CTRL_s_axi \
			ports {$port_CTRL} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sobel_top_CTRL_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sobel_top_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
